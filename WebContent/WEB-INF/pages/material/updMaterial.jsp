...
<%@page import="pe.tgestiona.logistica.inversa.bean.MaterialBean"%>
<jsp:useBean id="materialBeanData" scope="request" class="pe.tgestiona.logistica.inversa.bean.MaterialBean" />
					...
					<tr>
						<td>
						 <form:form action="registrarMaterial.do" method="POST" id="frmMaterial" name="frmMaterial">
							...
							<h2>Actualización de Materiales</h2>
								<br><br>
								<table align="center" border="0" cellpadding="0" cellspacing="0"
											width="110%">
									<tr>
										...
										<td style="text-align: left;">
											<input type="text" name="t_codigo" id="t_codigo" value="${materialBean.codigo}" readonly="readonly" style="background-color: gray;">
									...
									<tr>
										...
										<td style="text-align: left;">
											<input type="text" name="t_descripcion" id="t_descripcion" size="100" value="${materialBean.descripcion}"><br>
									...
									<tr>
										...
										<td style="text-align: left;">
											<input type="text" name="t_umd" id="t_umd" size="3" value="${materialBean.umd}">
									...
									<tr>
										...
										<td style="text-align: left;">
											<input type="text" name="t_peso" id="t_peso" size="10" value="${materialBean.peso}">
									...
									<tr>
										...
										<td style="text-align: left;">
											<input type="text" name="t_volUnitario" id="t_volUnitario" size="10" value="${materialBean.volUnitario}">
									...
									<tr>
										...
										<td style="text-align: left;">
											<input type="text" name="t_precio" id="t_precio" size="10" value="${materialBean.precio}">
									...
									<tr>
										...
										<td style="text-align: left;">	
											<c:set var="seriado" scope="session" value="${materialBean.seriado}"/>											
											<c:choose>
											   <c:when test="${seriado=='SI'}">
											   ...
											   <c:when test="${seriado=='NO'}">
													<input type="radio" name="rdbSerNoSer" id="rdbSer" value="SI">Seriado		
													<input type="radio" name="rdbSerNoSer" id="rdbNoSer" value="NO" checked="checked">No Seriado																				 												   
											   </c:when>
											</c:choose>
									...
									<tr>
										...
										<td style="text-align: left;">
											<c:set var="lotizable" scope="session" value="${materialBean.lotizable}"/>
											<c:choose>
											   <c:when test="${lotizable=='SI'}">
											   ...
											   <c:when test="${lotizable=='NO'}">
													<input type="radio" name="rdbLotizable" id="rdbLotizableSI" value="SI">Lotizable
													<input type="radio" name="rdbLotizable" id="rdbLotizableNO" value="NO" checked="checked">No Lotizable
											   </c:when>
											</c:choose>
