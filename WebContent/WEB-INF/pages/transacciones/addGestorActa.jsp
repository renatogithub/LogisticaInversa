...
<script type="text/javascript" src="resources/js/gestorActa.js?ver=02072015"></script>
...
<body onload="loadGestor();">
	<form:form action="registrarGestorActa.do" method="POST" id="frmGestorActa" name="frmGestorActa">
	...
	<h2>Registro de Gestor del Acta</h2>
	<fieldset style="padding: 10px;">
	<input type="hidden" name="t_entidad" id="t_entidad">
		<table border=0>
			<tr>
				<td><strong> Nombre de Gestor:</strong></td>
				<td>
