...
<script type="text/javascript" src="resources/js/planeamiento.js?ver=16.06.15A"></script>
		...
		<div id="contenido">
			...
			<div id="derecha">
				...
				<table align="center" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td>
						<form:form action="cargaFuentePlaneamiento.do" method="POST" enctype="multipart/form-data" class="formProcesar" id="formProcesar" name="formProcesar" modelattribute="uploadForm">
							...
							<div id="wizard" class="swMain" style="position:relative;z-index:2;">
								<ul>
									...
									<li><a href="#step-2"> <span class="stepNumber">2</span>
										<span class="stepDesc"> Fuente Planeamiento<br /> <small>Registrar Datos de Planeamiento</small>
										</span>
									</a></li>
									...
									<div id="step-1">
										<div>
											<h2 class="StepTitle" style="background-color: green;color: white;">Carga de informacion de Planeamiento</h2>									
										</div>
													...
													<table border="0" style="text-align: top;float: left;">
														<tr>
															<td vAlign="top" align="center" style="width: 120px;">
																<a id='miEnlaceDescargaFuentePlaneamiento' href='' style="text-align: center;"><small>Descargar <br>Fuente Planeamiento</small></a>
															</td>	
														</tr>
													</table>
												</div>
									...
									<div id="step-2">
										...
										<h2 class="StepTitle">Paso 2: Cargar Archivo Planeamiento</h2>
										<br/><br/>
										<table>
										
											<tr>
												<td>
													<h4>Fuente Planeamiento</h4>
												</td>
											</tr>
											<tr>
												<td>Selecciona Archivo Fuente Planeamiento:</td>
												<td>
													<div class="upload">
														<input type="file" name="files[0]" id="ficheroExcelPlaneamiento" style="margin-bottom: 20px;" />
														<span id="msg_fileExcelPlaneamiento" style="color: red;"></span> <br />
													</div>
												</td>
											</tr>
